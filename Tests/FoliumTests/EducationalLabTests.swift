...
/// Valida la respuesta del servidor y el comportamiento de Folium frente a cada endpoint /lab/*.
final class EducationalLabTests: XCTestCase {
    ...
    func testLabPublicPDF() {
        ...
        XCTAssertTrue(server?.contains("Folium-Lab/1.0") == true, "Server debe contener 'Folium-Lab/1.0', valor actual: \(server ?? "nil")")
