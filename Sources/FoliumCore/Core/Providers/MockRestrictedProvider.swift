...
public struct MockRestrictedProvider: DocumentProvider {
    ...
    public func resolveDownload(_ url: URL) async throws -> DownloadResult {
        ...
        return DownloadResult(
            url: fixtureFile,
            suggestedFilename: "Folium-Muestra-Educativa.pdf",
    ...
    public func locateFixtureURL() throws -> URL {
        ...
        let tempFixture = URL(fileURLWithPath: NSTemporaryDirectory()).appendingPathComponent("Folium-sample-document.pdf")
    ...
    public static func createMinimalPDFData() -> Data {
        ...
        /F1 24 Tf
        100 700 Td
        (Folium Educational Pipeline Sample) Tj
        ET
        endstream
        endobj
        5 0 obj
