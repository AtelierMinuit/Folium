...
public final class AppEnvironment {
    ...
    public var autoCheckClipboard: Bool {
        didSet {
            UserDefaults.standard.set(autoCheckClipboard, forKey: "Folium_AutoCheckClipboard")
        }
    }

    public var maxFileSizeBytes: Int64 {
        didSet {
            UserDefaults.standard.set(maxFileSizeBytes, forKey: "Folium_MaxFileSizeBytes")
        }
    }
    ...
    public init(store: SwiftDataStore = .shared) {
        ...
        self.autoCheckClipboard = UserDefaults.standard.bool(forKey: "Folium_AutoCheckClipboard")
        let savedMax = UserDefaults.standard.integer(forKey: "Folium_MaxFileSizeBytes")
